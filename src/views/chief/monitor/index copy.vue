    ...
    methods: {
                ...
                tooltip: {
                    ...
                    formatter: function(params){
                        ...
                        for(var i=0;i<params.length;i++){
                            str+='<div>'+params[i].marker+' '+params[i].seriesName+'：'+params[i].data+'℃</div>'
                        }
        ...
        getWarningLevel(){
            ...
            this.$axios.get(api,{
                ...
                this.warningLevelArr.orgTotel = redNum;
                this.warningLevelArr.yelTotel = redNum;
                this.warningLevelArr.blueTotel = redNum;

                this.warningLevelArr.redPer = redPer;
                this.warningLevelArr.orgPer = orgPer;
                this.warningLevelArr.yelPer = yelPer;
                this.warningLevelArr.bluePer = bluePer;
